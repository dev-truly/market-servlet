...
@WebServlet(name = "DefaultBoardModifyServlet", urlPatterns = {"/board/free/modify"})
public class DefaultBoardModifyServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        RequestDispatcher rd = req.getRequestDispatcher("/WEB-INF/views/board/default/modify.jsp?board=" + boardType + "&boardName=" + boardConfig.getBoardName() + "&" + req.getQueryString());
        rd.forward(req, resp);
    }
